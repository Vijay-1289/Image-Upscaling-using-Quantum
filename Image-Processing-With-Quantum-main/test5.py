...
# === STEP 6: Save TIFF Images ===
Image.fromarray(original_img).save("original_ascii_image.tiff")
Image.fromarray(input_matrix).save("upscaled_128x128_image.tiff")
print("Saved TIFF images: 'original_ascii_image.tiff' and 'upscaled_128x128_image.tiff'")
